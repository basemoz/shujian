...
void copy_status(object me, object ob, int job_lvl)
{
	...
	lvl = 20 + job_lvl;
	job_lvl += 9;
	qi = me->query("max_qi") * job_lvl / 10;
    	jing = me->query("max_jing") * job_lvl / 10;
 	neili = me->query("max_neili") * job_lvl / 10;
 	jingli = me->query("max_jingli") * job_lvl / 10;
 	exp = me->query("combat_exp") * job_lvl / 10;
...
void copy_skills(object me, object ob, int job_lvl)
{
	...
	lvl = me->query("max_pot") - 100;
 	...
 	ob->set("jiali", ob->query_skill("force", 1) / 5);
}
