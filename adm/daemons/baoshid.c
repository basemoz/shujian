...
void choose_baosi()
{
        ...
        message("channel:chat",HIG"【"+HIR"天降陨石"+HIG"】"+HIW"突然空中打了个炸雷,一个火球横空出世,拖着一道"+str+"光向"+dirname[j]+"的方向落去!\n"+NOR,users());
