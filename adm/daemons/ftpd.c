...
//   original from @TMI-2,  the "latest" ftp daemon, version 6.0
//   modified by versace, 20/8/97
//   if got root permission, should try the wu-ftp server. :)
...
/* 
 *   斩脚趾避沙虫，just like what they did in es2. :)
 *   if can't get it work, just comment it out. haha.. 
 *   -- versace, 20/8/97
 */
