...
int perform(object me, object target)
{
        ...
        lev = (int)me->query_skill("yiyang-zhi", 1)/2; // By Spiderii ^L^A^X^_^P^G^Y^[
        ...
        COMBAT_D->do_attack(me, target, 0, (lev*2>=350)?3:1);
        me->add_temp("yyz/yz3m",-1);
        if( me->is_fighting(target) && (int)me->query_skill("yiyang-zhi",1) > 179 ) {
