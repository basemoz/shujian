...
*/
        ...
        lvl = ((int)me->query_skill("tenglong-bifa",1)+(int)me->query_skill("huagu-mianzhang",1)+(int)me->query_skill("dagger",1))/6;
        message_vision(msg,me,target);
        me->receive_damage("jingli",100);
        me->receive_damage("neili",300);
        me->add_temp("apply/attack",lvl);
        me->add_temp("apply/damage",lvl*4/3);
...
//                weapon->wield();
        ...
        me->start_perform(3+random(4),"「小怜横陈」");
        return 1;
}
