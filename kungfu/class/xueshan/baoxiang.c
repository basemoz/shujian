// baoxiang.c 宝象
// by iceland
// By Spiderii@ty 郁闷中按照bt lsxk设想修改统一奖励
...
string ask_finish()
{
	...
	if (me->query("xs/girl_super")) 
                   TASKREWARD_D->get_reward(me,"雪山",-1,0,0,8,0,0,0,this_object());
	else
                   TASKREWARD_D->get_reward(me,"雪山",-1,0,0,3,0,0,0,this_object());
