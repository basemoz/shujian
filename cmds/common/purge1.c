...
int main(object me, string arg)
{
	...
	if( sscanf(arg, "%s because %s", name, reason)==2 ){
		...
		msg =   ""+name+ "，您好：\n"+
			"    我们现在通知您，您在"+CHINESE_MUD_NAME+"的ID已经被系统删除。删除原因\n"+
			"是“"+reason+"”。您的新ID已经转到 bxhn.mymud.com 8888，请登录新书剑游戏，\n"+
			"提醒您进入后，多看看 news 了解整个游戏的情况后，开始新游戏。\n"+
			"\n"+
			"此致\n"+
			"				书剑巫师组\n"+
			"\n"+ctime(time());
		...
		shout(HIR"\n【书剑通告】"+capitalize(name)+"因为『 "+reason+" 』消失在这个世界了。\n"NOR);
		write(HIR"\n【书剑通告】"+capitalize(name)+"因为『 "+reason+" 』消失在这个世界了。\n"NOR);
