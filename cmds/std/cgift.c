...
me->delete("quest/jiebai/pass");

}

// 凌波微步要求悟性 >= 22
if ( me->query("int") < 22 ){
me->delete("quest/dali/shanlu");
...
{
write("本指令用来修改先天属性。\n");
write(HIR"注意：如果修改悟性低于22，凌波微步将被删除。\n"NOR);
    write(HIR"注意：如果修改臂力高于20，金蛇剑法和金蛇掌法将被删除。\n"NOR);
write(HIR"注意：如果修改悟性高于25，左右互搏和结拜记号将被删除。\n"NOR);
write(HIR"警告如果不想调整属性,从新连接人物取消操作：\n"NOR);
